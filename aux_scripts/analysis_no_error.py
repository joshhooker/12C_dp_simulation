...
def chisq(obs, sim, error, num_parameters):
    chi = 0.
    count = 0
...
def analysis(input_file, output_file, num_parameters):
    ...
    chi2 = chisq(data_y, sim_y_scaled, data_yerr, num_parameters)
...
if __name__ == '__main__':
    mse, chi2 = analysis(sys.argv[1], sys.argv[2], sys.argv[3])
