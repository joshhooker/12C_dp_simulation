#ifndef NonResonantBackgroundProcess_h
#define NonResonantBackgroundProcess_h
...
class NonResonantBackgroundProcess : public G4VDiscreteProcess {
public:
    NonResonantBackgroundProcess(const G4String& name = "NonResonantBackground");
    ~NonResonantBackgroundProcess();
